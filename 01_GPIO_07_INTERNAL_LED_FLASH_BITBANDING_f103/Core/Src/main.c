...
/* USER CODE BEGIN PV */
 volatile unsigned int *GPIOA_PIN5 = (unsigned int*)BITBAND_PERI(GPIOA_ODR, 5);
...
/*
 * GPIO Hardware Register Memory Mapping
 * =====================================
...
eg. GPIOA_ODR
0x4001080C(physical address) = 0x40010800(BASE) + 0x0C(OFFSET)

unsigned long *rGPIOA_ODR= (unsigned long*)0x4001080C;
...
int main(void)
{
  ...
  while (1)
  {
  	volatile uint32_t* rGPIOA_ODR=(uint32_t*)0x4001080C;
